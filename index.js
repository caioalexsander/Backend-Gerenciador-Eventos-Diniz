  ...
  res.send(`
    ...
    <head>
      ...
      <style>
        ...
        button { padding: 15px 30px; margin: 10px; font-size: 18px; border: none; border-radius: 8px; }
    ...
    <body>
      ...
      <script>
        ...
        async function concluir(){
          ...
          await fetch('/contratos/assinar/${token}', {
            method: 'POST',
